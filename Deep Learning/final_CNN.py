...
model = Sequential()
model.add(Conv2D(filters=16, kernel_size=(2, 2), activation="relu", input_shape=(64,64,3)))
...
hist = model.fit(x_train, y_train, epochs=2, validation_data=(x_vali, y_vali), callbacks=callback)
